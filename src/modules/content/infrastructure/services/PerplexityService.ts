...
export class PerplexityService implements AiService {
   ...
   * ✅ ENHANCED: Supports new JSON structure with all article data
   */
  private parseArticleResponse(content: string): { title: string; content: string; rawResponse?: any } {
    ...
    try {
      ...
      // ✅ ENHANCED: Extract all available data from new JSON structure
      const result = {
      ...
      console.log('🤖 [PerplexityService] Enhanced JSON parsed result:', {
